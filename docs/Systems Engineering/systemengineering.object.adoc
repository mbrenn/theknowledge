...
Fragt man 10 verschiedene Personen nach der Definition eines konkreten Objektes, kann man, vereinfacht gesagt, 10 verschiedene Antworten erhalten, die sich teilweise überlappen, aber auch teilweise völlig widersprechen. 
...
Einige Dinge sind einfach... Wie ein Fahrzeug, aber selbst ein Fahrzeug kann in völlig unterschiedlichen Formen auftreten. Ist ein Auto ein Fahrzeug? Ist ein Fahrrad ein Fahrzeug oder ist ein Inline-Skater ein Fahrzeug? Oder reden wir über ein 'Eis'. Ist ein Eis zum Schlecken oder Gletscher-Eis gemeint? 
...
Nutzen wir mal Wikipedia... https://de.wikipedia.org/wiki/Objekt[Objekt] hilft eigentlich gar nicht. Hier fangen wir maximal die ersten zwei Punkte der obigen Liste ein, die wir beschreiben wollen. 
...
§ 90 BGB sagt: "Sachen im Sinne des Gesetzes sind nur körperliche Gegenstände"
