...
+
Ein platform-übergreifendes Tool zur C#/.Net Entwicklung unter Windows und Linux. Mein persönliches Entwicklungstool. Mittlerweile unterstützt es auch viele andere Dateiformate direkt inline... Geht in direkten Wettbewerb mit Visual Studio Code und einfach nur hervorragend, wenn auch kostenpflichtig.
